...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def backward(ctx, grad_out_color, grad_radii, _):
        ...
        #print("4000_anneal_grad_means2D:",grad_means2D.shape)
    
    
        scale_anneal_begin = 4000
        ...
        def scale_tensor(tensor, scaling_factor, iteration):
            ...
            decay_rate = step_decay(iteration)
            #print("decay_rate:",decay_rate)
            scaling_factor_expanded = scaling_factor_expanded * decay_rate + 1 * (1 - decay_rate)            
            #print(scaling_factor_expanded.mean(), scaling_factor_expanded.min(), scaling_factor_expanded.max())
            
            return tensor * scaling_factor_expanded        

        scaled_grad_means2D = scale_tensor(grad_means2D, scaling_factor, raster_settings.iteration)
        #print("wo gradient scale!")
